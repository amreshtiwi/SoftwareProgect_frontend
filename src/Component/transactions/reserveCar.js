...
function ReserveCar({ navigation, route, user }) {
  ...
  const createTransactionHandler = async () => {
    ...
    <html dir="rtl" lang="ar">
      <body>
        ...
        <p>حضر المنفذ له بالذات ${userExcutionForResult} وطلب إشعار المنفذ ضده بالحجز الواقع على المركبة (${carNumber}) من أجل ضبطها لدى الشرطة وعلى ذلك جرى التوقيع حسب الأصول</p>
        <br></br>
        <br></br>
