...
function LeaveClaim({ navigation, route, user }) {
  ...
  const createTransactionHandler = async () => {
    ...
    const claimTypeOrder = claimType == '0' ? 'مبرئ للذمة' : 'غير مبرئ للذمة'

    const transactionObject = {
      title: type ,
      description:"طلب ترك دعوه",
      type: "TYPE1",
      data: {
        userExcutionForResult:  userExcutionForResult ,
        claimTypeOrder: claimTypeOrder,
      },
    };
    ...
    <html dir="rtl" lang="ar">
      <body>
        ...
        <p> </p>
        <p>حضر المنفذ له بالذات ${userExcutionForResult} وطلب ترك الدعوى المرموقة ترك ${claimTypeOrder} وبذات الوقت استرداد المبرزات اصل الشيكات في هذه الدعوى حسب الاصول القانون وعليه جرى التوقيع</p>
        <br></br>
        <br></br>
