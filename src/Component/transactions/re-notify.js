...
function ReNotify({ navigation, route, user }) {
  ...
  const createTransactionHandler = async () => {
    ...
    <html dir="rtl" lang="ar">
      <body>
        ...
        <p>حضر المنفذ له بالذات ${userExcutionForResult} وطلب إعادة تبليغ المنفذ له المنفذ ضده على ذات العنوان وعليه جرى التوقيع</p> 
        <br></br>
        <br></br>
