...
function DententionRequest({ navigation, route, user }) {
  ...
  const createTransactionHandler = async () => {
    ...
    <html dir="rtl" lang="ar">
      <body>
        <h1>طلب أمر حبس</h1>
        <p>حضر المنفذ له بالذات ${userExcutionForResult} وطلب حبس المحكوم عليه لتبلغه حسب الأصول وعدم عرض تسوية قانونية وبذات الوقت الحجز على اموالها لدى البنوك العاملة في فلسطين ولدى وزارة النقل والمواصلات وتسطير الكتب اللازمة لذلك, وعليه جرى التوقيع</p>
         <br></br>
        <br></br>
...
export default DententionRequest;