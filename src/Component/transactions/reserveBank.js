...
function ReserveBank({ navigation, route, user }) {
  ...
  const createTransactionHandler = async () => {
    ...
    <html dir="rtl" lang="ar">
      <body>
        <h1>فك حجز مركبة</h1>
        <p>حضر المنفذ له بالذات ${userExcutionForResult} وطلب تسطير كتاب للحجز على الأموال السائلة لدى البنوك بإسم المنفذ ضده وعليه جرى التوقيع</p>
         <br></br>
        <br></br>
